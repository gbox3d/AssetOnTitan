...
var theApp = {
    ...
    config: {
        base_url : 'http://1.214.222.77:9304' ///sparkDeviceCommandCheck'
    },
    ...
    switch (operator) {
        case '01': //디지털쓰기
            ...
            (function() {
                ...
                port_number = 13 - parseInt(port_number);

                var led = document.querySelectorAll('#part-led .simdevice-led')[ port_number];
...
function fetchCommand(command) {
    ...
    $.ajax(
        {
            url: theApp.config.base_url + '/sparkDeviceCommandExec', //명령어 비우기
            type: 'GET',
            jsonp: 'callback',
